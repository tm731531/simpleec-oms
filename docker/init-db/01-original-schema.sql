-- SimpleEC OMS - Original Schema (cleaned)
...
COMMENT ON COLUMN public.merchant_config.responsible_account_id IS 'SimpleEC業務服務人員';
...
INSERT INTO public.sell_item (sell_item_id, "name", charge_method, price, currency, corp_item_number, unit, qty, insert_account_id, insert_time, modified_account_id, modified_time)
 VALUES('200', 'SimpleEC Open API使用權(年付)', 'annually', 18000.00, 'TWD', 'MISC501488', 'set', 1, 'cszj6P', '2023-10-24 15:54:30.207', 'cszj6P', '2023-10-24 15:54:30.205');
INSERT INTO public.sell_item (sell_item_id, "name", charge_method, price, currency, corp_item_number, unit, qty, insert_account_id, insert_time, modified_account_id, modified_time)
 VALUES('201', 'SimpleEC Open API使用權(月付)', 'monthly', 1500.00, 'TWD', 'MISC501488', 'set', 1, 'cszj6P', '2023-10-24 15:55:01.822', 'cszj6P', '2023-10-24 15:55:01.820');
INSERT INTO public.sell_item (sell_item_id, "name", charge_method, price, currency, corp_item_number, unit, qty, insert_account_id, insert_time, modified_account_id, modified_time)
...
(
    ...
    used_simpleec_shipping BOOLEAN NULL ,
    used_simpleec_shipping_time timestamp with time zone  NULL ,
    used_simpleec_shipping_last_week BOOLEAN Null,
    used_simpleec_shipping_last_week_time timestamp with time zone  NULL ,
    ...
    used_simpleec_draft_product  BOOLEAN NULL ,
    used_simpleec_draft_product_time timestamp with time zone  NULL ,
    used_simpleec_draft_product_last_week  BOOLEAN NULL ,
    used_simpleec_draft_product_last_week_time timestamp with time zone  NULL ,
...
COMMENT ON COLUMN public.merchant_info_statistic.used_simpleec_shipping IS '曾使用一站出貨';
COMMENT ON COLUMN public.merchant_info_statistic.used_simpleec_shipping_time IS '曾使用一站出貨_計算時間';
COMMENT ON COLUMN public.merchant_info_statistic.used_simpleec_shipping_last_week IS '上週有用一站出貨';
COMMENT ON COLUMN public.merchant_info_statistic.used_simpleec_shipping_last_week_time IS '上週有用一站出貨_計算時間';
...
COMMENT ON COLUMN public.merchant_info_statistic.used_simpleec_draft_product IS '曾經過用一站上架';
COMMENT ON COLUMN public.merchant_info_statistic.used_simpleec_draft_product_time IS '曾經過用一站上架_計算時間';
